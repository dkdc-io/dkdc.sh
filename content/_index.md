...
{{ install(name="bookmarks", display_name="Bookmarks", url="https://dkdc.io/bookmarks", github="dkdc-io/bookmarks", description="Bookmarks in your filesystem.") }}

{{ install(name="lm", display_name="dkdc-lm", url="https://dkdc.io/lm", github="dkdc-io/lm", description="Local LLM inference management via llama-server.") }}
